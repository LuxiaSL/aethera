...
class CollapseType(str, Enum):
    ...
    KILL = "kill"                      # /kill by an oper or the haunting entity
    SERVER_SHUTDOWN = "server_shutdown"  # the IRCd itself dies (Closing Link)
    TAKEOVER = "takeover"              # an entity seizes ops and forces everyone out
    ERASURE = "erasure"               # members/lines erased one by one (cursed)
