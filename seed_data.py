#!/usr/bin/env python3
"""
LuxiBlog Test Data Seeding Script
...
from luxiblog.utils.markdown import render_markdown, render_comment_markdown
...
def seed_data():
    ...
    with Session(engine) as session:
        ...
        post1 = create_post(
            session,
            title="Welcome to LuxiBlog",
            slug="welcome-to-luxiblog",
            author="Luxia",
            tags="meta, intro",
            days_ago=30,
            content="""
...
This is **LuxiBlog**, a minimalist blogging platform designed for readability and AI-friendliness.
...
LuxiBlog uses a 4chan-inspired comment system with several unique features.
...
"""
        ...
        post4 = create_post(
            session,
            title="LuxiBlog Technical Architecture",
            slug="luxiblog-technical-architecture",
            author="Luxia",
            tags="technical, architecture, documentation",
            days_ago=3,
            content="""
# LuxiBlog Technical Architecture

This document describes the complete technical architecture of LuxiBlog, a FastAPI-based blogging platform.
